<div class="modal fade" id="add_list" >
  ...
  <div class="modal-body">
    <form class="form-horizontal" style="margin-left:35px" method="post" action="/list/create">
        ...
        <input type="text" id="list-create-name" class="span6" placeholder="例: 阅读相关" name="list_title">
  ...
  <div class="modal-footer">
    ...
    <button type="submit" class="btn btn-primary" >创建列表</button>
  </div>
  </form>
</div>
  <script type="text/javascript">
  $(function () {
    // $('#add_list').modal('toggle');
  });
</script>